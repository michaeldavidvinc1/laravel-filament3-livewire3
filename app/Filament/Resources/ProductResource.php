            ...
            ->schema([
                Group::make()->schema([
                    Section::make('Product Information')->schema([
                        ...
                        TextInput::make('slug')->required()->maxLength(255)->disabled()->required()->dehydrated()->unique(Product::class, 'slug', ignoreRecord: true),
                ...
                Group::make()->schema([
                    ...
                    Section::make('Status')->schema([
                        ...
                        Toggle::make('in_active')->required()->default(true),
                        Toggle::make('in_feature')->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('is_stock')->boolean(),
